...
public class CorridorNode : Node
{
    ...
    {
        var relativePositionOfStructure2 = CheckPositionSturucture2AgainstStructure1();
    ...
    private void ProcessRoomInRelationUpORDown(Node structure1, Node structure2)
    {
        ...
        var possibleNeighborsInTopStructure = structureAboveChildren.Where(
            child => GetValidYForNeighborUpDown(
        ...
        int x = GetValidYForNeighborUpDown(
                bottomStructure.TopLeftAreaCorner,
                bottomStructure.TopRightAreaCorner,
    ...
    private int GetValidYForNeighborUpDown(Vector2Int bottomNodeLeft, Vector2Int bottomNodeRight, Vector2Int topNodeLeft, Vector2Int topNodeRight)
    {
    ...
    private RelativePosition CheckPositionSturucture2AgainstStructure1()
    {
        ...
        float angle = CalcuateAngle(middlePointStructure1Temp, middlePointStructure2Temp);
    ...
    private float CalcuateAngle(Vector2 middlePointStructure1Temp, Vector2 middlePointStructure2Temp)
    {
